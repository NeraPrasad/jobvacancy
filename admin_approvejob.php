...
<html>
  ...
  <body>
    ...
    ?>
    <?php require_once "include/admin_approvejob.inc.php"; ?>

    <h1>Approve Job</h1>



<form action="include/admin_approvejob.inc.php">
  ...
  <div class="mtable">
      <table >
        ...
        <tr>
          ...
          <td>
            <a href="include/admin_approvejob.inc.php?delete=<?php echo $row['ID']; ?>" name="delete" id="btn" onclick="return validate();">Delete</a>
          </td>
